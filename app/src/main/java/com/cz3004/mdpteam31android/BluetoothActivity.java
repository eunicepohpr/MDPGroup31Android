...
//            finish();
    ...
    public void connectBluetoothDevice(String address) {
        ...
        if (!connected)
            ...
            progress = ProgressDialog.show(BluetoothActivity.this, "Disconnecting...", "Please wait");
                ...
                case Constants.MESSAGE_STATE_CHANGE:
                    switch (msg.arg1) {
                        ...
                        case BluetoothService.STATE_CONNECTING: // bluetooth service is connecting to a device
                            ...
                            sendToMain(device); // send empty string to MainActivity to notify that no devices connected currently
                            break;
...
//    }
    ...
    protected void onDestroy() {
        ...
        destroyReceivers();
//        showToast("BluetoothActivity onResume");
